...
(function() {
	...
	// Container: container10.
		new videoBackground('container10', {
			target: '#container10',
			src: 'assets/videos/container10.mp4',
			poster: 'assets/videos/container10.mp4.jpg',
			position: 'center',
			loop: true
		});
	...
	// Initialize "On Visible" animations.
		onvisible.add('h1.style2, h2.style2, h3.style2, p.style2', { style: 'fade-down', speed: 750, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style5, h2.style5, h3.style5, p.style5', { style: 'fade-left', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style12, h2.style12, h3.style12, p.style12', { style: 'fade-up', speed: 750, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.buttons.style2', { style: 'fade-up', speed: 1000, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('.container.style2', { style: 'fade-in-background', speed: 2500, intensity: 5, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style1, h2.style1, h3.style1, p.style1', { style: 'fade-left', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style3, h2.style3, h3.style3, p.style3', { style: 'fade-up', speed: 750, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style6, h2.style6, h3.style6, p.style6', { style: 'fade-left', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('#image02', { style: 'fade-in', speed: 3000, intensity: 8, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style7, h2.style7, h3.style7, p.style7', { style: 'fade-left', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.buttons.style1', { style: 'fade-up', speed: 1000, intensity: 2, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style8, h2.style8, h3.style8, p.style8', { style: 'fade-left', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style11, h2.style11, h3.style11, p.style11', { style: 'fade-left', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style4, h2.style4, h3.style4, p.style4', { style: 'fade-up', speed: 750, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('h1.style9, h2.style9, h3.style9, p.style9', { style: 'fade-left', speed: 1000, intensity: 1, threshold: 3, delay: 0, replay: false });
		onvisible.add('.buttons.style5', { style: 'fade-up', speed: 1000, intensity: 2, threshold: 3, delay: 0, replay: false });
